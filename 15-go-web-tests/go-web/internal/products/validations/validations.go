...
func ValidateCodeValue(codeValue string, repo *repository.ProductRepository) bool {
...
func ValidateNewProduct(requestBody model.Product, repo *repository.ProductRepository) error {
	validCode := ValidateCodeValue(requestBody.CodeValue, repo)
	if validCode == false {
